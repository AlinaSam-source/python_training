...
class AddNewContact(unittest.TestCase):
    ...
    def test_add_new_contact(self):
        ...
        driver.find_element_by_name("firstname").send_keys("Alina")
        driver.find_element_by_name("middlename").click()
        driver.find_element_by_name("middlename").clear()
        driver.find_element_by_name("middlename").send_keys("Alina")
        driver.find_element_by_name("lastname").click()
        driver.find_element_by_name("lastname").clear()
        driver.find_element_by_name("lastname").send_keys("Alina")
        driver.find_element_by_name("nickname").click()
        driver.find_element_by_name("nickname").clear()
        driver.find_element_by_name("nickname").send_keys("Alina")
        driver.find_element_by_name("title").click()
        driver.find_element_by_name("title").clear()
        driver.find_element_by_name("title").send_keys("Alina")
        driver.find_element_by_name("company").click()
        driver.find_element_by_name("company").clear()
        driver.find_element_by_name("company").send_keys("Infopulse")
        driver.find_element_by_name("address").click()
        driver.find_element_by_name("address").clear()
        driver.find_element_by_name("address").send_keys("Polyova str 24D")
        ...
        driver.find_element_by_name("email2").send_keys("1234")
        driver.find_element_by_name("email3").click()
        driver.find_element_by_name("email3").clear()
        driver.find_element_by_name("email3").send_keys("1234")
        driver.find_element_by_name("homepage").click()
        driver.find_element_by_name("homepage").clear()
        driver.find_element_by_name("homepage").send_keys("1234")
        ...
        Select(driver.find_element_by_name("new_group")).select_by_visible_text("Alina")
        ...
        driver.find_element_by_name("notes").send_keys("1")
        driver.find_element_by_id("content").click()
        driver.find_element_by_xpath("(//input[@name='submit'])[2]").click()
        driver.find_element_by_link_text("home page").click()
        Select(driver.find_element_by_name("group")).select_by_visible_text("Alina")
